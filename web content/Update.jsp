...
<div class="container"> 
                ...
                <div class="row add-card ">
                    <form action="Upmyproduct" method="post" enctype = "multipart/form-data">
                    ...
                    <fieldset>
                 				<legend><font color="#F5DEB3" size = "6px">Edit Product</font></legend> 
                        <div class="row">
                        
                       <font color="#F5DEB3"> Product ID</font><input type = "text"  name = "id" value = "<%= rs.getString("ProductID")%>" readonly> 
                            ...
                            <div class="col-5">
                                <div class="input-row">
                                    ...
                                    <input type="text" class="input" name="name" id="name" placeholder="Enter Product name" value="<%= rs.getString("ProductName")%>"  required>
                                    <span class="error-txt" id="error-name"></span>
                                </div>
                                
                                <div class="input-row">
                                    <label for="price"> <font color="#F5DEB3" size = "3px">	Product price</font></label>
                                    <input type="number" min="0" class="input" name="price" id="price" placeholder="Enter Product price" value="<%= rs.getString("ProductPrice")%>" required>
                                    <span class="error-txt" id="error-price"></span>
                                </div>
                                
                                <div class="input-row">
                                    <label for="qty"><font color="#F5DEB3" size = "3px">Product Code</font></label>
                                    <input type="number" min="0" class="input" name="code" id="qty" placeholder="Enter Product Code" value="<%= rs.getString("ProductCode")%>"  required>
                                ...
                                <div class="input-row">
                                    ...
                                    <textarea class="input" name="dec" id="dec" placeholder="Enter Product description" required> <%= rs.getString("ProductDescription")%></textarea>
                                ...
                                <div class="btn-row">
                                   <button class="btn-save" id="submit" type="submit" >Update</button>                                   
