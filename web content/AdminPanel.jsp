...
.boxes .box .button:hover {background-color: #CD5C5C}

.boxes .box.button:active {
...
<body>
    <nav>
        <div class="logo-name">
            ...
            <span class="logo_name">YummyFoods</span>
        </div>
            ...
            <div class="overview">
                ...
                <div class="boxes" >
                    <div class="box box1">
                        ...
                        <button class = "button"  value="Add" >Add Product </button></a>
...
<table>
	...
	<td>
	 <a href="Update.jsp?id=<%=id%>" class="btn-edit">
       <i class="uil uil-file-edit-alt"></i>
       </a>
    <a href="Delete.jsp?id=<%=id%>" class="btn-edit">
